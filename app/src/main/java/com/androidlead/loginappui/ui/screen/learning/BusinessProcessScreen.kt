...
@Composable
fun BusinessProcessScreen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeBusinessProcess() },
        bottomBar = {
            BottomAppBarComposeBusinessProcess(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            AndroidView(
                ...
                update = { webView ->
                    webView.loadUrl("https://elma365.com/ru/articles/urok-7-ispolnenie-biznes-processov-smodelirovannyh-v-bpmn/")
                }
            )
        }
    }
...
@Composable
fun TopAppBarComposeBusinessProcess() {
    TopAppBar(
...
@Composable
fun BottomAppBarComposeBusinessProcess(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
