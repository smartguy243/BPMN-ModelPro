...
@Composable
fun Builder2Screen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeBuilder2() },
        bottomBar = {
            BottomAppBarComposeBuilder2(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
...
@Composable
fun BottomAppBarComposeBuilder2(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
