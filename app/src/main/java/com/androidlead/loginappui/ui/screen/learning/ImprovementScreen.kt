...
@Composable
fun ImprovementScreen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeImprovement() },
        bottomBar = {
            BottomAppBarComposeImprovement(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            AndroidView(
                ...
                update = { webView ->
                    webView.loadUrl("https://elma365.com/ru/articles/urok-8-uluchshenie-biznes-processov-pri-pomoshi-bpmn/")
                }
            )
        }
    }
...
@Composable
fun TopAppBarComposeImprovement() {
    TopAppBar(
...
@Composable
fun BottomAppBarComposeImprovement(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
