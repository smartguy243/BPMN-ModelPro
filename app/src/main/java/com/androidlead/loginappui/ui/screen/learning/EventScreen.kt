...
@Composable
fun EventScreen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeEvent() },
        bottomBar = {
            BottomAppBarComposeEvent(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            AndroidView(
                ...
                update = { webView ->
                    webView.loadUrl("https://elma365.com/ru/articles/urok-2-sobytiya-i-shlyuzy-v-bpmn/")
                }
            )
        }
    }
...
@Composable
fun BottomAppBarComposeEvent(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
