...
@Composable
fun TypeScreen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeType() },
        bottomBar = {
            BottomAppBarComposeType(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            AndroidView(
                ...
                update = { webView ->
                    webView.loadUrl("https://elma365.com/ru/articles/urok-3-instrumenty-personalizacii-v-bpmn-zadachi-zona-otvetstvennosti/")
                }
            )
        }
    }
...
@Composable
fun BottomAppBarComposeType(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
