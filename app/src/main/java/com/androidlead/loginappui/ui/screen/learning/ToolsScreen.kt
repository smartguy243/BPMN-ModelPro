...
@Composable
fun ToolsScreen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeTools() },
        bottomBar = {
            BottomAppBarComposeTools(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            AndroidView(
                ...
                update = { webView ->
                    webView.loadUrl("https://elma365.com/ru/articles/urok-5-sredstva-opovesheniya-v-bpmn/")
                }
            )
        }
    }
...
@Composable
fun BottomAppBarComposeTools(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
