...
@Composable
fun ArtefactScreen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeArtefact() },
        bottomBar = {
            BottomAppBarComposeArtefact(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            AndroidView(
                ...
                update = { webView ->
                    webView.loadUrl("https://elma365.com/ru/articles/urok-6-ispolzovanie-artefaktov-i-dannyh-v-bpmn/")
                }
            )
        }
    }
...
@Composable
fun BottomAppBarComposeArtefact(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
