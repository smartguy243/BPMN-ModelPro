...
@Composable
fun ProcessScreen(onOpenMenuClicked: () -> Unit,
                     onLearnClicked: () -> Unit) {
    Scaffold(topBar = { TopAppBarComposeProcess() },
        bottomBar = {
            BottomAppBarComposeProcess(onOpenMenuClicked, onLearnClicked)
        }
    ) { innerPadding ->
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            AndroidView(
                ...
                update = { webView ->
                    webView.loadUrl("https://elma365.com/ru/articles/urok-4-prakticheskoe-ispolzovanie-podprocessov-v-bpmn/")
                }
            )
        }
    }
...
@Composable
fun BottomAppBarComposeProcess(onOpenMenuClicked: () -> Unit, onLearnClicked: () -> Unit) {
    BottomAppBar(
